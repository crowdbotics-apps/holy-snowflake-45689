"""
Django settings for holy_snowflake_45689 project.
...
ROOT_URLCONF = 'holy_snowflake_45689.urls'
...
WSGI_APPLICATION = 'holy_snowflake_45689.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "holy_snowflake_45689 API",
    "DESCRIPTION": "API documentation for holy_snowflake_45689 App",
    "VERSION": "v1",
}
